...
export default function Auto(props) {
        ...
        const banner = "url('/banner/Auto_banner.png')";
        const icon = "/dat_icon/Auto_head.png";
        const inf = { code: "AUTO", tit: "Tự động hóa" };
                ...
                geocode(RequestType.ADDRESS, paddr.current.value)
                        ...
                        .catch((error) => {
                                ...
                                alertDispatch({
                                        type: "LOAD_CONTENT",
                                        payload: {
                                                content: dataLang.formatMessage({ id: "alert_30" }),
                                                show: "block",
                                        },
                                });
                        });
        ...
        const handleSaveFix = (e) => {
                ...
                if (fixtype === "FIX_D") {
                        ...
                        const updatelistDevice = async () => {
                                await axios
                                        .post(
                                                host.DEVICE + "/updatelistDevice",
                                                {
                                                        id: code,
                                                        name: dname.current.value,
                                                        des: ddescription.current.value,
                                                },
                                                { secure: true, reconnect: true }
                                        )
                                        .then(function (res) {
                ...
                if (fixtype === "DEL_P") {
                        ...
                        if (type === "admin" || type === "master") {
                                const removelistProject = async () => {
                                        await axios
                                                .post(
                                                        host.DEVICE + "/removelistProject",
                                                        { user: props.username, id: code },
                                                        { secure: true, reconnect: true }
                                                )
                                                .then(function (res) {
                                                        // console.log(res.data);
                                                        if (res.data.status) {
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_17" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                        } else {
                                ...
                                const removelistProjectUser = async () => {
                                        await axios
                                                .post(
                                                        host.DEVICE + "/removelistProjectUser",
                                                        { user: props.username, id: code },
                                                        { secure: true, reconnect: true }
                                                )
                                                .then(function (res) {
                ...
                if (fixtype === "DEL_D") {
                        ...
                        if (type === "admin" || type === "master") {
                                                ...
                                                .then(function (res) {
                                                        ...
                                                        if (res.data.status) {
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_16" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                        } else {
                                ...
                                const removelistDeviceUser = async () => {
                                        await axios
                                                .post(
                                                        host.DEVICE + "/removelistDeviceUser",
                                                        { user: props.username, id: code },
                                                        { secure: true, reconnect: true }
                                                )
                                                .then(function (res) {
        ...
        const columnproject = [
                {
                        name: "STT",
                        selector: (row) => <div className="DAT_Table_Stt">{row.id}</div>,
                        width: "80px",
                        center: true,
                },
                {
                                ...
                                <div style={{ width: "100%" }}>
                                        {row.status ? (
                                                <img
                                                        alt=""
                                                        style={{ width: "30px" }}
                                                        src="/lib/true_state.png"
                                                ></img>
                                        ) : (
                                                <img
                                                        alt=""
                                                        style={{ width: "30px" }}
                                                        src="/lib/warning_state.png"
                                                ></img>
                                        )}
                                </div>
                        ),
                        ...
                        selector: (row) => (
                                <>
                                        <div className="DAT_Table">
                                                <span
                                                        className="DAT_Table-edit"
                                                        id={row.projectid + "_MORE"}
                                        ...
                                        <div
                                                className="DAT_Modify"
                                                id={row.projectid + "_Modify"}
                                                style={{ display: "none" }}
                                                onMouseLeave={(e) => handleModify(e, "none")}
                                        >
                                                <div
                                                        className="DAT_Modify_fix"
                                                        id={row.projectid + "_FIX_P"}
                                                        onClick={(e) => handleFix(e)}
                                                >
                                                        Chỉnh sửa
                                                </div>
                                                <div
                                                        className="DAT_Modify_remove"
                                                        id={row.projectid + "_DEL_P"}
                                                        onClick={(e) => handleFix(e)}
                                                >
                                                        Gỡ
                                                </div>
                                ...
                                <div style={{ width: "100%" }}>
                                        ...
                                        {row.status ? (
                                                <img
                                                        alt=""
                                                        style={{ width: "25px" }}
                                                        src="/lib/online_state.png"
                                                ></img>
                                        ) : (
                                                <img
                                                        alt=""
                                                        style={{ width: "25px" }}
                                                        src="/lib/offline_state.png"
                                                ></img>
                                        )}
                                </div>
                        ),
                ...
                },
                {
                        ...
                        selector: (row) => (
                                <label
                                        ...
                                        style={{ cursor: "pointer", color: "#326ba8" }}
                                >
                                        {row.deviceid}
                                </label>
                        ),
                ...
                },
                {
                        ...
                        selector: (row) => (
                                <>
                                        ...
                                        <div
                                                className="DAT_Modify"
                                                id={row.deviceid + "_Modify"}
                                                style={{ display: "none" }}
                                                onMouseLeave={(e) => handleModify(e, "none")}
                                        >
                                                <div
                                                        className="DAT_Modify_fix"
                                                        id={row.deviceid + "_FIX_D"}
                                                        onClick={(e) => handleFix(e)}
                                                >
                                                        Chỉnh sửa
                                                </div>
                                        ...
                                        return (
                                                <div className="DAT_TableGroup" key={i}>
                                                        ...
                                                        <div
                                                                ...
                                                                id={`${data.deviceid}_${data.groupid}_${data.curtab}_Group`}
                                                                onClick={(e) => {
                                                                        handleDeviceGroup(e);
                                                                }}
                                                        >
        ...
        useEffect(() => {
                const getDevice = async () => {
                        await axios
                                .post(
                                        host.DEVICE + "/getlistDevice",
                                        { username: props.username, group: inf.code },
                                        { secure: true, reconnect: true }
                                )
                                .then(function (res) {
                                        if (res.data.status) {
                        ...
                        if (whatdevice !== "") {
                                ...
                                if (view.value.type == "single") {
                                        const getMonitor = async () => {
                                                ...
                                                await axios
                                                        .get(host.DEVICE + "/getMonitorDevice/" + whatdevice, {
                                                                secure: true,
                                                        })
                                                        .then(function (res) {
                                                                ...
                                                                settingDispatch({
                                                                        type: "LOAD_SCREEN",
                                                                        payload: {
                                                                                currentID: whatdevice,
                                                                                currentName: newarr[0].name,
                                                                ...
                                                                axios
                                                                        .get(host.DEVICE + "/getTabMD/" + whatdevice, {
                                                                                secure: true,
                                                                                reconnect: true,
                                                                        })
                                                                        .then(function (res) {
                                                                                settingDispatch({
                                                                                        type: "LOAD_LASTTAB",
                                                                                        payload: parseInt(res.data[0].tab),
                                                                                });
                                                                                settingDispatch({
                                                                                        type: "LOAD_DEFAULT",
                                                                                        payload: parseInt(res.data[0].defaulttab),
                                                                                });
                                                                        });
                                                        })
                                                        .catch((err) => {
                                        ...
                                        const getMonitorDevice = async () => {
                                                ...
                                                await axios
                                                        .post(
                                                                host.DEVICE + "/getMonitorDeviceGroup",
                                                                { id: whatdevice, groupid: view.value.id },
                                                                { secure: true, reconnect: true }
                                                        )
                                                        .then(function (res) {
                                                                // console.log("Screen data", res.data.data);
                ...
                if (pageDefault.value.type == "project") {
                        ...
                        if (p.length === 1) {
                                ...
                                SetDirect([
                                        { id: "home", text: "Trang chủ" },
                                        { id: "list", text: inf.tit },
                                        { id: "project", text: p[0].name },
                                ]);
                                overviewDispatch({
                                        type: "LOAD_DEVICE",
                                        payload: {
                                                id: p[0].data.id,
                                                visual: p[0].data.data,
                                                setting: p[0].setting,
                                                company: p[0].company,
                                                name: p[0].name,
                                        },
        ...
        const handleDevice = (event) => {
                ...
                const getMonitorDevice = async () => {
                        rootDispatch(toolslice.actions.setstatus(true));
                        await axios
                                .get(host.DEVICE + "/getMonitorDevice/" + arr[0], {
                                        secure: true,
                                        reconnect: true,
                                })
                                .then(function (res) {
                                        ...
                                        axios
                                                .get(host.DEVICE + "/getTabMD/" + arr[0], {
                                                        secure: true,
                                                        reconnect: true,
                                                })
                                                .then(function (res) {
                ...
                if (arr[0] !== "device") {
                        if (arr[0] === "project") {
                                ...
                                SetDirect([
                                        { id: "home", text: "Trang chủ" },
                                        { id: "list", text: inf.tit },
                                        { id: "project", text: showproject[0].name },
                                ]);
                        }
        ...
        const handleAddproject = (e) => {
                ...
                if (type === "admin" || type === "master") {
                        const addlistProject = async () => {
                                await axios
                                        .post(
                                                host.DEVICE + "/addlistProject",
                                                { username: props.username, projectid: p.value, code: inf.code },
                                                { secure: true, reconnect: true }
                                        )
                                        .then(function (res) {
                                                // console.log(res.data);
                                                if (res.data.status) {
                                                        alertDispatch({
                                                                type: "LOAD_CONTENT",
                                                                payload: {
                                                                        content: dataLang.formatMessage({ id: "alert_43" }),
                                                                        show: "block",
                                                                },
                                                        });
                                                        axios
                                                        ...
                                                        if (res.data.number === 1) {
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_45" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                                ...
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_44" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                        } else {
                        ...
                        const addlistProjectbyUser = async () => {
                                await axios
                                        .post(
                                                host.DEVICE + "/addlistProjectbyUser",
                                                {
                                                        admin: admin,
        ...
        const handleAdddevice = (e) => {
                ...
                if (type === "admin" || type === "master") {
                                        ...
                                        .then(function (res) {
                                                ...
                                                if (res.data.status) {
                                                        alertDispatch({
                                                                type: "LOAD_CONTENT",
                                                                payload: {
                                                                        content: dataLang.formatMessage({ id: "alert_40" }),
                                                                        show: "block",
                                                                },
                                                        });
                                                        axios
                                                        ...
                                                        if (res.data.number === 1) {
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_50" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                        } else if (res.data.number === 2) {
                        ...
                        const addlistDevicebyUser = async () => {
                                await axios
                                        .post(
                                                host.DEVICE + "/addlistDevicebyUser",
                                                {
                                                        admin: admin,
                                                        username: props.username,
                                                        deviceid: d.value,
                                                ...
                                                if (res.data.status) {
                                                        ...
                                                        if (res.data.number === 1) {
                                                                alertDispatch({
                                                                        type: "LOAD_CONTENT",
                                                                        payload: {
                                                                                content: dataLang.formatMessage({ id: "alert_46" }),
                                                                                show: "block",
                                                                        },
                                                                });
                                                        } else if (res.data.number === 2) {
                                                                ...
                                                                case "list":
                                                                        return (
                                                                                <div className="DAT_View_Content_Tit">
                                                                                        ...
                                                                                        <div className="DAT_View_Content_Tit-content">
                                                                                                {inf.tit}
                                                                                        </div>
                                                                                </div>
                                                                        );
                                                                case "project":
                                                                        return (
                                                                                <div className="DAT_View_Content_Project">
                                                                                        <img
                                                                                                alt=""
                                                                                                className="DAT_View_Content_Project-avatar"
                                                                                                src={avatar}
                                                                                        ></img>
                                                                        ...
                                                                        return (
                                                                                <>
                                                                                        {showproject.map((data, index) => (
                                                                                                <div
                                                                                                        key={index}
                                                                                                        className="DAT_View_Content_Overview"
                                                                                                        id="DAT_overview"
                                                                                                >
                                                                                                        <Tooloverview
                                                                                                                username={props.username}
                                                                        ...
                                                                        <>
                                                                                <div className="DAT_Mobile_Container">
                                                                                        ...
                                                                                        <div className="DAT_Mobile_Container_Bar">
                                                                                                ...
                                                                                                <div
                                                                                                        className="DAT_Mobile_Container_Bar_project"
                                                                                                        onClick={() => {
                                                                                                                tab.value = "1";
                                                                                                        }}
                                                                                                >
                                                                                                        <div
                                                                                                                className="DAT_Mobile_Container_Bar_project_bg"
                                                                                                                style={{
                                                                                                        ...
                                                                                                        ></div>
                                                                                                        <div
                                                                                                                className="DAT_Mobile_Container_Bar_project_add"
                                                                                                                style={{
                                                                                                ...
                                                                                                <div
                                                                                                        className="DAT_Mobile_Container_Bar_device"
                                                                                                        onClick={() => {
                                                                                                                tab.value = "2";
                                                                                                        }}
                                                                                                >
                                                                                                        <div
                                                                                                                className="DAT_Mobile_Container_Bar_device_bg"
                                                                                                                style={{
                                                                                                        ...
                                                                                                        ></div>
                                                                                                        <div
                                                                                                                className="DAT_Mobile_Container_Bar_device_add"
                                                                                                                style={{
                                                                                                ...
                                                                                                {tab.value === "1" ? (
                                                                                                        <>
                                                                                                                {project.map((data, index) => (
                                                                                                                        <div
                                                                                                                                key={index}
                                                                                                                                className="DAT_Mobile_Container_Content"
                                                                                                                        >
                                                                                                                                <div className="DAT_Mobile_Container_Content_Top">
                                                                                                                                        <div
                                                                                                                                                className="DAT_Mobile_Container_Content_Top_left"
                                                                                                                                                id={data.projectid + "_PROJECT"}
                                                                                                                                                onClick={(e) => {
                                                                                                                                                        handleProject(e);
                                                                                                                                                }}
                                                                                                                                        >
                                                                                                                                        ...
                                                                                                                                        <div className="DAT_Mobile_Container_Content_Top_right">
                                                                                                                                                <div
                                                                                                                                                        className="DAT_Mobile_Container_Content_Top_right_tit"
                                                                                                                                                        id={data.projectid + "_PROJECT"}
                                                                                                                                                        onClick={(e) => {
                                                                                                                                                                handleProject(e);
                                                                                                                                                        }}
                                                                                                                                                ...
                                                                                                                                                <div className="DAT_Mobile_Container_Content_Top_right_company">
                                                                                                                                                        Công ty: {data.company}
                                                                                                                                                </div>
                                                                                                                                                <div className="DAT_Mobile_Container_Content_Top_right_state">
                                                                                                                                                        Trạng thái:{" "}
                                                                                                                                                        {data.status ? (
                                                                                                                                                                <img
                                                                                                                                                                        alt=""
                                                                                                                                ...
                                                                                                                                <div className="DAT_Mobile_Container_Content_Bottom">
                                                                                                                                        <div className="DAT_Mobile_Container_Content_Bottom_addr">
                                                                                                                                                {data.addr}
                                                                                                                                        </div>
                                                                                                                ...
                                                                                                                {listdevice2.map((data, index) => (
                                                                                                                        ...
                                                                                                                        >
                                                                                                                                <div className="DAT_Mobile_Container_Content_Top">
                                                                                                                                        ...
                                                                                                                                        <div className="DAT_Mobile_Container_Content_Top_right">
                                                                                                                                                <div className="DAT_Mobile_Container_Content_Top_right_tit">
                                                                                                                                                        {data.name}
                                                                                                                                                </div>
                                                                                                                                                <div className="DAT_Mobile_Container_Content_Top_right_company">
                                                                                                                                                        SN: {data.deviceid}
                                                                                        ...
                                                                                        >
                                                                                                <div className="DAT_Mobile_Overview_Head">
                                                                                                        ...
                                                                                                        <div className="DAT_Mobile_Overview_Head_tit">
                                                                                                                {direct.map((data, index) => {
                                                                                                                        return index === 1 ? (
                                                                                                                                <div
                                                                                                                                        ...
                                                                                                                                        className="DAT_Mobile_Overview_Head_tit_bu"
                                                                                                                                >
                                                                                                                                        {data.text}
                                                                                                                                </div>
                                                                                                                        ) : (
                                                                                                                ...
                                                                                                                <div className="DAT_Mobile_Overview_Head_tit_name">
                                                                                                                        {data.name}
                                                                                                                </div>
                                                                                                        </div>
                                                                                                </div>
