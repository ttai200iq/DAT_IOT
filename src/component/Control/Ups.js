...
export default function Ups(props) {
        ...
        const avatar = '/avatar/ups.jpg'
        const banner = "url('/banner/UPS_banner.png')"
        const icon = "/dat_icon/UPS_head.png"
        const inf = { code: 'UPS', tit: 'UPS' }
        const iconmobile = <AiOutlineDatabase color="gray" size={25} />
